...
(function (window, document) {
    ...
    Msg.prototype = {
        _init({
            ...
            header = false, //是否显示头部信息及关闭按钮
            title = "", //弹窗标题
            contentStyle = {}, //内容样式
            contentFontSize = "1.5em", //内容字体大小
            btnName = ["确定", "取消"], //按钮文字内容
            foot_num = 2,//是否显示底部的确认按钮，数字量
        }) {
            //将传入的值绑定到this上 
        ...
        _creatElement() {
            ...
            //定义弹窗得两个按钮
            switch (this.foot_num) {
                case 1:
                    var [cancelBtnName_var] = this.btnName;
                    break;
                case 2:
                    var [confirmBtnName_var, cancelBtnName_var] = this.btnName;
                    break;
            }
            const [confirmBtnName, cancelBtnName] = [confirmBtnName_var, cancelBtnName_var]
            ...
            switch (this.foot_num) {
                case 1:
                    // console.log(1)
                    var footer_here = `<div class="msg-footer">
            ...
            const footerHTML = this.footer ? footer_here : "";
